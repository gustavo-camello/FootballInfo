namespace FootballInfo.Migrations
{
    ...
    public partial class EmptyMigration : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            CreateIndex("dbo.PlayerClubs", "Club_ClubId");
            CreateIndex("dbo.PlayerClubs", "Player_PlayerId");
            CreateIndex("dbo.Clubs", "Tournament_TournamentId");
            AddForeignKey("dbo.Clubs", "Tournament_TournamentId", "dbo.Tournaments", "TournamentId");
            AddForeignKey("dbo.PlayerClubs", "Club_ClubId", "dbo.Clubs", "ClubId", cascadeDelete: true);
            AddForeignKey("dbo.PlayerClubs", "Player_PlayerId", "dbo.Players", "PlayerId", cascadeDelete: true);
        }
    }
}
